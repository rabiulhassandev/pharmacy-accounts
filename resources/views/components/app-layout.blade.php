            ...
            <details class="relative">
                ...
                <div class="absolute right-0 top-full z-30 mt-3 w-72 overflow-hidden rounded-2xl border border-gray-700/70 bg-gray-900/95 p-3 shadow-2xl shadow-black/40 backdrop-blur-xl">
                    <nav class="space-y-2">
                        ...
                        <a href="{{ route('months.index') }}" class="flex items-center rounded-xl px-4 py-3 transition-colors {{ request()->routeIs('months.*') || request()->routeIs('ledger.*') ? 'bg-emerald-500/10 text-emerald-400' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
